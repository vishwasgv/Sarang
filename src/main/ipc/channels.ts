...
export interface IpcChannels {
  ...
  creditInterest: {
    ...
    reverse: (payload: { chargeId: string; reason: string }) => Promise<ApiResponse>
  }
  postDatedCheques: {
    create: (payload: unknown) => Promise<ApiResponse>
  ...
  logisticsChallan: {
    ...
    get: (payload: string) => Promise<ApiResponse>
    create: (payload: { challanType?: string; customerId?: string; customerName: string; customerAddress?: string; shipmentId?: string; invoiceId?: string; vehicleId?: string; driverName?: string; driverPhone?: string; customerGstin?: string; placeOfSupply?: string; transportReason?: string; transporterName?: string; lrNumber?: string; dispatchDate?: string; expectedReturn?: string; notes?: string; items: Array<{ productId?: string; productName: string; hsnCode?: string; quantity: number; unit?: string; unitValue?: number; notes?: string }> }) => Promise<ApiResponse>
    update: (payload: { id: string; challanType?: string; customerName?: string; customerAddress?: string; vehicleId?: string | null; driverName?: string; driverPhone?: string; customerGstin?: string; placeOfSupply?: string; transportReason?: string; transporterName?: string; lrNumber?: string; dispatchDate?: string; expectedReturn?: string | null; notes?: string; items?: Array<{ productId?: string; productName: string; hsnCode?: string; quantity: number; unit?: string; unitValue?: number; notes?: string }> }) => Promise<ApiResponse>
    updateStatus: (payload: { id: string; status: string }) => Promise<ApiResponse>
