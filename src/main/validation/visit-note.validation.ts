...
export const CreateVisitNoteSchema = z.object({
  ...
  isSecondOpinion: z.boolean().optional(),
  caseComplexity: z.enum(['ROUTINE', 'COMPLEX']).optional(),
...
export const UpdateVisitNoteSchema = z.object({
  ...
  referredByPhone: z.string().nullable().optional(),
  referredByEmail: z.string().nullable().optional(),
  isSecondOpinion: z.boolean().optional(),
  caseComplexity: z.enum(['ROUTINE', 'COMPLEX']).nullable().optional(),
