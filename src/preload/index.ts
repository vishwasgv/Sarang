...
const api: IpcChannels = {
  ...
  templateSuggestion: {
    get: () => invoke('templateSuggestion:get'),
    isDismissed: () => invoke('templateSuggestion:isDismissed'),
    dismiss: () => invoke('templateSuggestion:dismiss')
  },
  customDocuments: {
    listTypes: (p) => invoke('customDocuments:listTypes', p),
    createType: (p) => invoke('customDocuments:createType', p),
    updateType: (p) => invoke('customDocuments:updateType', p),
    listEntries: (documentTypeId) => invoke('customDocuments:listEntries', documentTypeId),
    createEntry: (p) => invoke('customDocuments:createEntry', p),
    updateEntry: (p) => invoke('customDocuments:updateEntry', p),
    deleteEntry: (id) => invoke('customDocuments:deleteEntry', id)
  },
  invoiceTemplates: {
  ...
  bankRules: {
    ...
    update: (p) => invoke('bankRules:update', p),
    remove: (p) => invoke('bankRules:remove', p),
    suggestions: (p) => invoke('bankRules:suggestions', p),
    apply: (p) => invoke('bankRules:apply', p)
  },
  bins: {
  ...
  stockTakes: {
    list: () => invoke('stockTakes:list'),
    get: (p) => invoke('stockTakes:get', p),
    start: (p) => invoke('stockTakes:start', p),
    setCounts: (p) => invoke('stockTakes:setCounts', p),
    post: (p) => invoke('stockTakes:post', p),
    cancel: (p) => invoke('stockTakes:cancel', p)
  },
  hubs: {
  ...
  gstPayments: {
    ...
    void: (p) => invoke('gstPayments:void', p)
  },
  fixedAssets: {
  ...
  tax: {
    ...
    staleRates: () => invoke('tax:staleRates'),
    deactivateStale: (p) => invoke('tax:deactivateStale', p),
  ...
  reports: {
    ...
    vatReturn: (p) => invoke('reports:vatReturn', p),
    generic: (p) => invoke('reports:generic', p),
    ...
    cashPositionTrend: (p) => invoke('reports:cashPositionTrend', p),
    ...
    jobCardTurnaroundByTechnician: (p) => invoke('reports:jobCardTurnaroundByTechnician', p),
    repairCategoryVolumeTrend: (p) => invoke('reports:repairCategoryVolumeTrend', p),
    fieldRepLeaderboard: (p) => invoke('reports:fieldRepLeaderboard', p),
    ...
    candidatePipelineFunnel: () => invoke('reports:candidatePipelineFunnel'),
    jobOrderFunnel: () => invoke('reports:jobOrderFunnel'),
    feePercentage: () => invoke('reports:feePercentage'),
    timeToFill: (p) => invoke('reports:timeToFill', p),
    sourceEffectiveness: () => invoke('reports:sourceEffectiveness'),
    ...
    scheduleH1XRegister: (p) => invoke('reports:scheduleH1XRegister', p),
    ...
    repairTurnaroundByTechnician: () => invoke('reports:repairTurnaroundByTechnician'),
  ...
  analytics: {
    ...
    getDashboardAlerts: (lang?: string) => invoke('analytics:getDashboardAlerts', lang),
  ...
  restaurant: {
    ...
    markKOTServed: (p) => invoke('restaurant:markKOTServed', p),
    listKOTsForWaiter: (p) => invoke('restaurant:listKOTsForWaiter', p),
    generateWaiterQr: (p) => invoke('restaurant:generateWaiterQr', p),
  ...
  distributor: {
    ...
    listBeats: (p) => invoke('distributor:listBeats', p),
    createBeat: (p) => invoke('distributor:createBeat', p),
    updateBeat: (p) => invoke('distributor:updateBeat', p),
    deleteBeat: (p) => invoke('distributor:deleteBeat', p),
    addBeatStop: (p) => invoke('distributor:addBeatStop', p),
    removeBeatStop: (p) => invoke('distributor:removeBeatStop', p),
    moveBeatStop: (p) => invoke('distributor:moveBeatStop', p),
    getCustomerCreditRisk: (p) => invoke('distributor:getCustomerCreditRisk', p),
  },
  repairTickets: {
    ...
    lookupSerialService: (p) => invoke('repairTickets:lookupSerialService', p),
    updateStatus: (p) => invoke('repairTickets:updateStatus', p),
    recordVendorClaim: (p) => invoke('repairTickets:recordVendorClaim', p),
    recordVendorRecovery: (p) => invoke('repairTickets:recordVendorRecovery', p),
    writeOffVendorClaim: (p) => invoke('repairTickets:writeOffVendorClaim', p),
  },
  returns: {
  ...
  variants: {
    ...
    sizeCurveReorderSuggestion: (p) => invoke('variants:sizeCurveReorderSuggestion', p),
  ...
  jobCards: {
    ...
    getRepeatFaultSummary: () => invoke('jobCards:getRepeatFaultSummary'),
    getPartsVarianceSummary: () => invoke('jobCards:getPartsVarianceSummary'),
  },
  workLogs: {
  ...
  hotel: {
    ...
    occupancyTrend: (p) => invoke('hotel:occupancyTrend', p),
    roomWiseADR: (p) => invoke('hotel:roomWiseADR', p),
    adrRevPAR: (p) => invoke('hotel:adrRevPAR', p),
  ...
  quotations: {
    ...
    convertToSalesOrder: (id: string) => invoke('quotations:convertToSalesOrder', id),
