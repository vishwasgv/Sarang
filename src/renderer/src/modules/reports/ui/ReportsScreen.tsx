...
const REPORT_DEF_META: { id: ReportType; icon: React.ReactNode; category: string; requiresDateRange: boolean; requiresEntity?: 'customer' | 'supplier'; permission: string; requiredModule?: TemplateModule; requiredBusinessType?: string | string[]; outsideIndiaOnly?: boolean }[] = [
  ...
  { id: 'profitByItem', icon: <BarChart3 size={18} />, category: 'finance', requiresDateRange: true, permission: 'analytics.viewProfit' },
  { id: 'profitByCustomer', icon: <BarChart3 size={18} />, category: 'finance', requiresDateRange: true, permission: 'analytics.viewProfit' },
  { id: 'receivablesSummary', icon: <BarChart3 size={18} />, category: 'customers', requiresDateRange: true, permission: 'reports.outstanding' },
  { id: 'payablesSummary', icon: <BarChart3 size={18} />, category: 'suppliers', requiresDateRange: true, permission: 'reports.financial' },
  { id: 'salesRegister', icon: <BarChart3 size={18} />, category: 'sales', requiresDateRange: true, permission: 'reports.sales' },
  { id: 'expenseByCategory', icon: <BarChart3 size={18} />, category: 'finance', requiresDateRange: true, permission: 'reports.financial' },
  { id: 'expenseByVendor', icon: <BarChart3 size={18} />, category: 'finance', requiresDateRange: true, permission: 'reports.financial' },
  { id: 'fixedAssetRegister', icon: <BarChart3 size={18} />, category: 'finance', requiresDateRange: true, permission: 'reports.financial' },
  { id: 'stockSummary', icon: <Package size={18} />, category: 'inventory', requiresDateRange: true, permission: 'reports.inventory' },
  { id: 'stockLedger', icon: <Package size={18} />, category: 'inventory', requiresDateRange: true, permission: 'reports.inventory' },
  { id: 'inventoryAgeing', icon: <Package size={18} />, category: 'inventory', requiresDateRange: true, permission: 'reports.inventory' },
  { id: 'stockByLocation', icon: <Package size={18} />, category: 'inventory', requiresDateRange: true, permission: 'reports.inventory' },
  { id: 'transfersRegister', icon: <Package size={18} />, category: 'inventory', requiresDateRange: true, permission: 'reports.inventory' },
  ...
  { id: 'taxByPart', icon: <BarChart3 size={18} />, category: 'finance', requiresDateRange: true, permission: 'reports.financial' },
