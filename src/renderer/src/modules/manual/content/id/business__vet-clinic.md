...
- **Overview** — detail pasien, kartu pemilik terkait, dan sebuah log **Weight History**. Tambahkan penimbangan baru kapan saja; setelah ada dua entri atau lebih, sebuah grafik tren kecil memplot berat dari waktu ke waktu.
...
- **Appointments** — riwayat kunjungan lengkap pasien dengan status (Scheduled, Confirmed, In Progress, Completed, Cancelled, No-show).
