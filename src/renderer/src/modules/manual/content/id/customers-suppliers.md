...
## Menambahkan pelanggan dan pemasok

Buka **Pelanggan** atau **Pemasok** dari sidebar untuk melihat daftar lengkap. Klik **Tambah Pelanggan** / **Tambah Pemasok** untuk membuat satu. Catatan pelanggan menyimpan nama, telepon, email, alamat (kota/provinsi/negara), nomor pajak, batas kredit, dan catatan; catatan pemasok menyimpan detail sisi bisnis yang setara (nama, telepon, email, alamat, nomor pajak, catatan).

Keduanya dapat **diarsipkan** alih-alih dihapus, yang menyembunyikannya dari daftar sehari-hari (penagihan, pembuatan pesanan pembelian, dan sebagainya) tanpa kehilangan riwayat transaksinya.

## Buku besar dan saldo tertunggak
...
## Pola tambah-cepat pencarian-telepon

Di mana pun Sarang membutuhkan Anda untuk melampirkan pelanggan ke sesuatu — faktur baru, penawaran (quotation), janji temu, check-in hotel, dan sebagainya — ia menggunakan kotak pencarian **CustomerPicker** yang sama: mulai ketik nama atau nomor telepon, dan kecocokan yang sudah ada akan muncul dalam dropdown dalam sekejap. Jika pelanggan belum ada, **+ Add new customer** memperluas formulir inline hanya untuk nama dan telepon, dan langsung memilih pelanggan yang baru dibuat tanpa meninggalkan layar tempat Anda berada.

Ini disengaja: mencari berdasarkan nomor telepon sebelum membuat catatan baru adalah yang mencegah orang yang sama berakhir sebagai beberapa entri Pelanggan duplikat di berbagai bagian aplikasi. Selalu cari terlebih dahulu — jika seorang pelanggan pernah dibuat dari layar mana pun di Sarang, nomor teleponnya akan menemukan mereka kembali di sini.
