...
Laporan **Batch Expiry** (Reports → Batch Expiry) mengubah data yang sama menjadi nilai uang: selain menunjukkan berapa banyak batch di setiap jendela kedaluwarsa, laporan ini sekarang juga menampilkan **nilai berisiko** yang sebenarnya di setiap kategori, sehingga Anda dapat melihat sekilas bukan hanya "12 batch akan kedaluwarsa" tetapi juga persis berapa nilai stok yang diwakilinya — dan angka terpisah "Nilai Berisiko" menjumlahkan apa yang masih dapat dipulihkan (stok yang sudah kedaluwarsa adalah kerugian yang sudah pasti, bukan sesuatu yang bisa diperbaiki dengan pemesanan ulang atau retur, sehingga dikecualikan dari total tersebut).
