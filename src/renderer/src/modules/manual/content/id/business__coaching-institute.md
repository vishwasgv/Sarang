...
**Syllabus.** Perluas sebuah batch dan buka panel Syllabus-nya untuk membangun checklist topik-demi-topik untuk batch tersebut — tambahkan topik, centang saat Anda mencakupnya, dan sebuah progress bar menunjukkan fraksi silabus yang benar-benar selesai. Membatalkan centang sebuah topik menghapus tanggal penyelesaiannya, sehingga pelacak selalu mencerminkan apa yang sebenarnya sudah diajarkan, bukan hanya apa yang direncanakan.
...
**Fees** menghasilkan catatan biaya sebulan untuk setiap pendaftaran aktif dalam satu klik, secara opsional menerapkan tarif GST (sebuah pendaftaran waitlisted dilewati secara otomatis — hanya ditagih setelah dipromosikan ke Active). Setiap catatan menunjukkan jumlah jatuh tempo, jumlah diterima, dan status Pending, Partial, Paid, atau Waived, dengan catatan terlambat ditandai secara otomatis setelah tanggal jatuh temponya berlalu. Anda dapat menandai sebuah biaya lunas sepenuhnya, mengedit pembayaran parsial, atau membebaskannya sepenuhnya, dan mencetak tanda terima biaya — yang mencakup kode QR UPI untuk saldo tersisa mana pun di mana pengumpulan UPI diatur.
...
**Performances & Recitals** adalah fitur terpisah dari Test Scores — ini untuk pemesanan acara dan resital, bukan nilai akademik. Gunakan untuk hal-hal seperti fungsi hari tahunan, sebuah resital musik, atau pertunjukan public speaking: catat nama pertunjukan, tanggal, tempat, dan siswa terdaftar mana dari sebuah batch yang berpartisipasi. Ini adalah daftar acara sederhana, bukan evaluasi bernilai — padukan dengan Test Scores ketika sebuah pertunjukan juga sedang dinilai.

## Bahasa

Coaching Institute adalah salah satu dari 24 template bisnis-layanan khusus Sarang, dan seperti hampir semuanya antarmukanya **hanya bahasa Inggris**, terlepas dari bahasa mana yang telah Anda tetapkan di tempat lain di Sarang.
