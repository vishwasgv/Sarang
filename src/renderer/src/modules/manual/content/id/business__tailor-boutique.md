...
Setiap pesanan mencatat jenis pakaian (Kemeja, Celana, Setelan Jas, Kurta, Salwar Kameez, Blus, Lehenga, Blus Saree, Jaket, Lainnya), jenis kelamin, wilayah gaya (India atau Barat), siapa yang menyediakan kain (klien atau toko) dan deskripsinya, kuantitas, harga satuan, dan uang muka yang dibayarkan — dengan saldo yang harus dibayar dihitung otomatis.
...
Tailor / Boutique adalah **satu pengecualian yang disengaja** di antara template bisnis-layanan Sarang: setiap jenis bisnis lain dalam keluarga ini berjalan hanya dalam bahasa Inggris, tetapi layar Tailor / Boutique sepenuhnya diterjemahkan dan bekerja dalam **ke-13 bahasa yang didukung Sarang**, sama seperti bisnis berbasis-produk seperti Retail atau Pharmacy. Ubah bahasa antarmuka Anda dari **Settings → Language** seperti biasa — Tailoring Orders dan Measurements akan mengikutinya.
