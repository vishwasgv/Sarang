...
**Skema Harga** (`/pricing/schemes`) adalah penawaran promosi yang dievaluasi secara otomatis saat checkout: **Beli X Dapat Y Gratis** (mis. beli 2, dapat 1 gratis) dan **Diskon Volume** (mis. diskon 10% untuk 5+ unit, 15% untuk 10+, dengan sebanyak apa pun titik batas yang Anda inginkan). Buat skema, batasi ke satu produk atau seluruh kategori, atur aturannya, dan opsional berikan tanggal mulai dan akhir untuk penawaran waktu terbatas.
