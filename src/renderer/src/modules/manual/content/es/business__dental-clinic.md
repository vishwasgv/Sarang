...
Haga clic en **History** en cualquier diente para ver su registro cronológico completo — cada condición que se le ha asignado alguna vez, en orden, no solo el estado actual. Volver a guardar un diente (digamos, de Caries a Obturado después del tratamiento) nunca borra la entrada anterior; ambas permanecen en el historial del diente para que tenga una línea de tiempo genuina del tratamiento de ese diente.
