...
Al recibir el artículo, registre su **condición al llegar** y los **accesorios recibidos** — una protección real contra disputas, para que "el cliente dijo que el cargador estaba incluido" pueda responderse consultando lo que realmente se registró cuando llegó el artículo, sin depender de la memoria. Asigne al trabajo una **categoría** de texto libre (p. ej. "Reparación de Pantalla," "Reemplazo de Batería") para poder rastrear el volumen de reparaciones por tipo. Si conoce el costo de las piezas de antemano, ingrese un **total de piezas cotizadas** al recibir el artículo — una vez que se agreguen las piezas reales más tarde, la propia vista de detalle de la orden de trabajo muestra la **variación de piezas** en vivo entre lo cotizado y lo realmente usado, en rojo si se excedió.

Sarang también marca automáticamente una **falla repetida**: si el mismo cliente trae de vuelta el mismo artículo dentro de los 30 días de una entrega anterior, la nueva orden de trabajo se marca justo al crearla — una señal de calidad real, no algo que usted tenga que notar por sí mismo.
