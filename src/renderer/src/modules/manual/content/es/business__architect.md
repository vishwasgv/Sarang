...
Mover un plano a **Approved** requiere registrar quién realmente dio la aprobación — Sarang le pedirá el nombre del aprobador si aún no está registrado, y no permitirá que el cambio de estado se realice sin uno. Esto le da un rastro de aprobación de cliente genuino, no solo una etiqueta de estado.
