...
Los **Esquemas de Precios** (`/pricing/schemes`) son ofertas promocionales que se evalúan automáticamente en el checkout: **Compre X Lleve Y Gratis** (por ejemplo, compre 2, lleve 1 gratis), **Descuento por Volumen** (por ejemplo, 10% de descuento en 5+ unidades, 15% en 10+, con tantos puntos de quiebre como desee), y **Happy Hour / % de Descuento Fijo** (un porcentaje de descuento fijo sin umbral de cantidad — el típico "4–6 p. m., 20% de descuento"). Cree un esquema, restríjalo a un producto o a toda una categoría, configure su regla, y opcionalmente proporcione una fecha de inicio y fin para una oferta por tiempo limitado, una hora de inicio y fin diaria para una ventana estilo happy hour (p. ej. 4:00 p. m.–6:00 p. m. — esto no puede cruzar la medianoche), o ambas a la vez.
