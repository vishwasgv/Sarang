...
La participación de un proveedor en sus compras aparece en varios lugares conectados en lugar de una sola pantalla: **Órdenes de compra** filtradas o buscadas por nombre de proveedor, el propio libro del proveedor (que refleja cada orden de compra recibida y cada pago realizado contra él), y cualquier **Notas de Débito** generada contra una orden de compra con ese proveedor. Juntos, estos le dan una imagen completa de lo que ha comprado a un proveedor y de lo que actualmente le debe.
