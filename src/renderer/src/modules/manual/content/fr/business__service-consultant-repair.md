...
À la réception, notez l'**état à l'arrivée** de l'article et les **accessoires reçus** — une véritable protection contre les litiges, afin que "le client a dit que le chargeur était inclus" puisse être vérifié en consultant ce qui a réellement été noté à l'arrivée de l'article, sans dépendre de la mémoire. Attribuez à la fiche une **catégorie** en texte libre (par ex. "Réparation d'écran," "Remplacement de batterie") afin de pouvoir suivre le volume de réparations par type. Si vous connaissez le coût des pièces à l'avance, saisissez un **total des pièces devisées** à la réception — une fois les pièces réelles ajoutées plus tard, la fiche de travail affiche elle-même l'**écart de pièces** en direct entre ce qui a été devisé et ce qui a été réellement utilisé, en rouge en cas de dépassement.

Sarang signale également automatiquement une **panne récurrente** : si le même client rapporte le même article dans les 30 jours suivant une livraison précédente, la nouvelle fiche de travail est signalée dès sa création — un véritable signal de qualité, pas quelque chose que vous devez remarquer vous-même.
