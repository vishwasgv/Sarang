...
**How stock appears in your books.** Sarang keeps stock the way Tally and Zoho Books do. Goods you buy on a supplier bill (or a received Purchase Order) go into the **Inventory** asset, not into expenses. When you sell, the cost of what you sold moves out of Inventory into **Cost of Goods Sold**, using the cost at the time of the sale. A return puts the goods back at that cost. Services on a bill (freight, rent) are expenses. A stock count difference, damage or expiry is booked against Cost of Goods Sold. Stock you type in by hand (opening stock) is booked against Owner's Capital. Because of this the Balance Sheet, the Profit and Loss report and the Sales report tell the same story. If you upgraded from an older version, your stock on hand was brought into the books once at cost on first start; sales made before the upgrade have no cost of goods entry, so start your first Profit and Loss period from the upgrade date.
