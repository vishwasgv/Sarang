...
**Leads** is the same drag-and-drop pipeline (Open → Contacted → Proposal → Won → Lost) used across Sarang's consulting-style verticals, and **Retainers** handles recurring client agreements — Fixed Fee, Hourly Bucket, or Deliverable-Based — with one-click monthly invoice generation. See the *Independent Consultant* chapter for the full walkthrough of both.
...
Software Agency is one of Sarang's 24 dedicated service-business templates, and like nearly all of them its interface is **English only**, regardless of which language you've set elsewhere in Sarang.
