...
2. **Adjust quantity and discount** on each cart line. Quantity steps by whole units, or by 0.1 for a weight-priced item. Discount can be entered either as a currency amount or a percentage — the small toggle button next to the discount field switches between the two.
