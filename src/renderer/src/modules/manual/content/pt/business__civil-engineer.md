...
Cada visita também tem um painel **Tests** para resultados estruturados de testes de materiais — tipo de teste, material, valor medido, unidade, e o mínimo exigido. O Sarang marca automaticamente um teste como Aprovado ou Reprovado assim que tanto o valor medido quanto o mínimo exigido são informados; sem um mínimo exigido, ele é registrado como Pendente em vez de adivinhado.
