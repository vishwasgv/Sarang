...
No recebimento, registre a **condição na chegada** do item e os **acessórios recebidos** — uma proteção real contra disputas, para que "o cliente disse que o carregador estava incluído" possa ser respondido consultando o que foi realmente registrado quando o item chegou, sem depender da memória. Dê à ordem de serviço uma **categoria** de texto livre (ex. "Reparo de Tela," "Substituição de Bateria") para que o volume de reparos possa ser rastreado por tipo. Se você souber o custo das peças com antecedência, insira um **total de peças orçadas** no recebimento — assim que as peças reais forem adicionadas depois, a própria visualização de detalhes da ordem de serviço mostra a **variação de peças** ao vivo entre o que foi orçado e o que foi realmente usado, em vermelho se excedeu.

O Sarang também sinaliza automaticamente uma **falha repetida**: se o mesmo cliente trouxer de volta o mesmo item dentro de 30 dias de uma entrega anterior, a nova ordem de serviço é sinalizada logo na criação — um sinal de qualidade real, não algo que você precise perceber sozinho.
