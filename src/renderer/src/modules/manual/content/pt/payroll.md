...
O aviso mostrado abaixo da lista de deduções vale a pena ler: o Sarang calcula o salário bruto e soma as deduções que você informa, mas não calcula os valores estatutários de PF/ESI/TDS para você — esses valores precisam vir do seu próprio contador ou das regras de folha de pagamento aplicáveis, informados aqui como simples linhas de dedução.
