-- AlterTable
ALTER TABLE "BusinessProfile" ADD COLUMN "drugLicenseNumber" TEXT;

-- AlterTable
ALTER TABLE "InvoiceItem" ADD COLUMN "prescriptionDate" DATETIME;
ALTER TABLE "InvoiceItem" ADD COLUMN "prescriptionDoctorName" TEXT;
ALTER TABLE "InvoiceItem" ADD COLUMN "prescriptionPatientName" TEXT;
